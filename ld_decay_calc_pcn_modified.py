# modified from https://speciationgenomics.github.io/ld_decay/
...
# 'rt' (text mode) is required in Python 3 -- gzip.open defaults to binary mode,
# which would return bytes instead of str for each line.
...
for chr in chr_distance_ld:
    ...
    for distance in sorted(chr_distance_ld[chr]):
        ...
        # round to closest 1000, and add to new structure. Round to 500 (all from 0-1000).
