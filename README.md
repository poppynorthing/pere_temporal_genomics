...
sequence_trim_align.md -- includes code for trimming reads through checking read mapping statistics.

variant_calling.md -- includes code for variant calling through joint genotyping.
