...
[sequence_trim_align.md](https://github.com/poppynorthing/pere_temporal_genomics/blob/main/sequence_trim_align.md) -- code for trimming reads through checking read mapping statistics. \
...
ld_decay_calc_pcn_modified.py -- [Speciation Genomics'](https://speciationgenomics.github.io/ld_decay/) python script for calculating average LD intervals, modified to run in python/3.11
